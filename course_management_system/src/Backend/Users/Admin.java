...
public class Admin extends User {
    ...
    public void addStudent(String studentName, String courseName) {
        ...
        try {
            ...
            st.executeUpdate("INSERT INTO STUDENT_INFO(STUDENT_NAME,COURSE_NAME) VALUES('" + studentName + "','"
                    + courseName + "');");
            for (int i = 0; i < moduleTypes.size(); i++) {
                st.executeUpdate(
                        "INSERT INTO STUDENT_ENROLLMENT(STUDENT_NAME,COURSE_NAME,MODULE_NAME,MODULE_TYPE,STATUS) VALUES('"
                                + studentName + "','" + courseName + "','" + moduleNames.get(i) + "','"
                                + moduleTypes.get(i) + "','Not Enrolled');");
            }
    ...
    public void editStudent(String id, String studentName, String courseName) {
        try {
            Statement st = connection.createStatement();
            st.executeUpdate("UPDATE STUDENT_INFO SET STUDENT_NAME='" + studentName + "',COURSE_NAME='" + courseName
                    + "' WHERE ID=" + id);
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    public boolean addCourse(String courseName, String courseDuration) {
        try {
            Statement addCourseSt = connection.createStatement();
            addCourseSt.executeUpdate("INSERT INTO COURSES_INFO(COURSE_NAME,COURSE_DURATION,ADDED_BY) VALUES ('"
                    + courseName + "', '" + courseDuration + "','" + username + "');");
            return false;
        } catch (SQLException e) {
            return true;
        }
    ...
    public void editCourse(String id, String courseName, String courseDuration) {
        try {
            Statement st = connection.createStatement();
            st.executeUpdate("UPDATE COURSES_INFO SET COURSE_NAME='" + courseName + "',COURSE_DURATION='" + courseDuration
                    + "' WHERE ID=" + id);
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    public void addTeacher(String name, String module, String course) {
        try {
            ...
            st1.executeUpdate("INSERT INTO TEACHER_INFO(TEACHER_NAME,COURSE_NAME,MODULE_NAME) VALUES('" + name + "','"
                    + course + "','" + module + "');");
            st2.executeUpdate("UPDATE MODULES_INFO SET TEACHER_NAME ='" + name + "' WHERE MODULE_NAME='" + module
    ...
    public void editTeacher(String id, String name, String course, String module) {
        try {
            ...
            Statement st1 = connection.createStatement();
            Statement st2 = connection.createStatement();
            st.executeUpdate("UPDATE TEACHER_INFO SET TEACHER_NAME='" + name + "',COURSE_NAME='" + course
                    + "',MODULE_NAME='" + module + "' WHERE ID=" + id);
            st1.executeUpdate("UPDATE MODULES_INFO SET TEACHER_NAME ='" + name + "' WHERE MODULE_NAME='" + module
                    + "' AND COURSE_NAME='" + course + "';");
            st2.executeUpdate("UPDATE MODULES_INFO SET MODULE_NAME ='" + module + "' WHERE TEACHER_NAME='" + name
                    + "' AND COURSE_NAME='" + course + "';");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    public void addModule(String courseName, String moduleName, String moduleType,String moduleYear) {
        try {
            Statement st = connection.createStatement();
            st.executeUpdate("INSERT INTO MODULES_INFO(MODULE_NAME,COURSE_NAME,MODULE_TYPE,MODULE_YEAR) VALUES('" + moduleName
                    + "','" + courseName + "','" + moduleType +"','"+moduleYear+ "');");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }

    public void editModule(String id, String moduleName, String courseName, String moduleType,String moduleYear) {
        try {
            Statement st = connection.createStatement();
            st.executeUpdate("UPDATE MODULES_INFO SET MODULE_NAME='"+moduleName+"', COURSE_NAME='"+courseName+"', MODULE_TYPE='"+moduleType+"', MODULE_YEAR='"+moduleYear+"' WHERE ID="+id);
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }
    public void deleteModule(String id, String moduleName) {
        try {
            ...
            st1.executeUpdate(
                    "UPDATE TEACHER_INFO SET MODULE_NAME='Not Available' WHERE MODULE_NAME='" + moduleName + "';");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }

    public int getCourseDuration(String courseName){
        String course_duration = "";
        try {
            Statement st = connection.createStatement();
            ResultSet res = st.executeQuery("SELECT * FROM COURSES_INFO WHERE COURSE_NAME='"+courseName+"'");
            while(res.next()){
                course_duration = res.getString("COURSE_DURATION");
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
        return parseInt(course_duration);
    }
    ...
    public void fetchModuleTableData(JTable table) {
        String query = "SELECT ID,COURSE_NAME,MODULE_NAME,MODULE_TYPE,MODULE_YEAR FROM MODULES_INFO";
        DefaultTableModel model = (DefaultTableModel) table.getModel();
        model.setRowCount(0);
        try {
            Statement st = connection.createStatement();
            ...
            while (res.next()) {
                ...
                String moduleYear = String.valueOf(res.getString("MODULE_YEAR"));
                String[] tbData = { id, course, module, moduleType ,moduleYear};
                model.addRow(tbData);
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
    ...
    public void fetchStudentReportData(JTable table,String studentName){
        String query = "SELECT ID,STUDENT_NAME,COURSE_NAME,MODULE_NAME,MARKS_OBTAINED FROM STUDENT_ENROLLMENT WHERE STUDENT_NAME='"+studentName+"' AND STATUS='ENROLLED' ;";
        DefaultTableModel model = (DefaultTableModel) table.getModel();
        model.setRowCount(0);
        try {
            Statement st = connection.createStatement();
            ...
            while (res.next()) {
                ...
                String module = String.valueOf(res.getString("MODULE_NAME"));
                String course = String.valueOf(res.getString("COURSE_NAME"));
                String student = String.valueOf(res.getString("STUDENT_NAME"));
                String marks = String.valueOf(res.getString("MARKS_OBTAINED"));
                String[] tbData = { id,student, course, module, marks };
                model.addRow(tbData);
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
